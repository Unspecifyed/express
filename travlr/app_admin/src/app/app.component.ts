...
@Component({
  ...
  standalone: true,
  imports: [RouterOutlet, ListTripsComponent, CommonModule, NavbarComponent]
})
  ...
  ngOnInit() {
    ...
    this.trips = [
      ...
      },
      {
        ...
        "description": "Description of the new place added.",
        "length": "4 days",
        "start": "2024-10-20",
        "resort": "New Resort",
        "perPerson": "$1000"
